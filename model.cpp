...
void Model::loadFromObj(QOpenGLFunctions_3_2_Core *f, std::string path, int hasTextures)
{
...
void Model::GLInit(QOpenGLFunctions_3_2_Core *f)
{
...
void Model::render(QOpenGLFunctions_3_2_Core *f, Camera &camera)
{
    f->glUseProgram(shaderProgram);
    f->glBindVertexArray(VAO);
    f->glBindBuffer(GL_ARRAY_BUFFER, VBO);
...
GLuint Model::loadShader(QOpenGLFunctions_3_2_Core *f, const char *filepath, GLenum type)
{
